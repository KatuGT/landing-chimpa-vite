              ...
              <div style={{ padding: "8px 0" }}>
                <div className="sib-input sib-form-block">
                  <div className="form__entry entry_block">
                    ...
                    >
                      Personalice este texto de ayuda opcional antes de publicar
                      su formulario.
                    </label>
                  </div>
                </div>
                      ...
                      >
                        ...
                        <div className="sib-sms-tooltip">
                          <div className="sib-sms-tooltip__box">
                            El campo SMS debe contener entre 6 y 19 cifras e
                            incluir el prefijo del país sin «+» ni «0» delante
              ...
              <div style={{ padding: "8px 0" }}>
                <div className="sib-input sib-form-block">
                  <div className="form__entry entry_block">
                    ...
                    >
                      Introduzca su dirección de e-mail para suscribirse. Ej.:
                      abc@xyz.com
                    </label>
                  </div>
                </div>
              ...
              <div style={{ padding: "8px 0" }}>
                ...
                `,
                      ...
                      <div
                        ...
                        id="sib-captcha"
                        data-sitekey="6Ld_bsIqAAAAACGjg1GTDmn5NE11KAGioxL4RGI1"
...
export default FormularioBrevo;
